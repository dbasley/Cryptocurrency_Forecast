...
The cryptocurrency market burst onto the scene in 2013, however it first appeared in 2009 when Bitcoin was created. Bitcoin has seen an incredible period of growth of growth over the past 10 years growing from approximately 300 USD to hitting its all time high just above 70,000 USD. Bitcoin is the largest coin and it is not particulary close. With a market cap of 1.3 trillion USD, the next closest coin is Ethereum with a market cap of 357.8 billion USD and Binance coin being 4th with a market cap of 80.8 billion USD, (per https://www.coinbase.com/explore as of 4/18). Bitcoin being substantially larger than all of the other coins led, while making up 57% of the market led us to believe that other coins performance are dependent on Bitcoin's performance as the leader. 

It should be noted that Bitcoin is known as a storage of value coin with a finite supply whereas Ethereum abd BNB can be mined unlimitedly and can have an infinite amount of supply. It is possible this aspect of Bitcoin is a large factor in its growth and popularity. 
...
test_results <- data.frame(Test_Statistic = test_statistics, P_Value = p_values)
